...
public class HdcBifromqPlugin extends BifroMQPlugin<HdcBifromqPluginContext> {
    private static final Logger log = LoggerFactory.getLogger(HdcBifromqPlugin.class);
    ...
    public HdcBifromqPlugin (BifroMQPluginDescriptor descriptor){
        super(descriptor);
